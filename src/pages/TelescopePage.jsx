    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-12 lg:px-16 text-center">
          ...
          />
          <p className="text-base text-secondary-80 font-light leading-relaxed max-w-2xl mx-auto mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {statsData.map((stat, i) => (
              ...
              >
                ...
                <p className="text-sm text-secondary-80 font-light">{stat.label}</p>
              </motion.div>
            ))}
          </div>
