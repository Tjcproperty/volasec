...
export default function WhiteHero() {
  ...
  return (
    <section
      id="hero"
      className="relative bg-secondary/30 min-h-[100svh] flex items-center justify-center pt-20 sm:pt-24 overflow-hidden"
    >
      {/* Background image */}
      <motion.div
      ...
      {/* Gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-light via-secondary/70 to-light z-[2]" />
      ...
      <motion.div
        ...
        style={{
          background: "radial-gradient(circle, #9f4325 0%, transparent 70%)",
        }}
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          <SectionBadge
            ...
            className="mb-8 text-primary-50 border-primary-30"
          />

          <BlurRevealHeading
            text="Security Architecture For High-Stakes Cloud Environments"
            as="h1"
            className="tracking-tight leading-[1.05] mb-6 sm:mb-8 text-4xl sm:text-5xl md:text-7xl font-normal text-primary"
          />
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-start">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="relative inline-flex items-center justify-center px-8 py-4 text-sm font-medium tracking-wider text-primary overflow-hidden group w-full sm:w-auto"
            >
              <motion.span
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-10 sm:mt-12">
            {[
              ...
              >
                <div className="text-2xl md:text-3xl font-normal text-primary">
                  {stat.number}
                </div>
