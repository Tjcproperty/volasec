...
const services = [
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "ISMS design, risk assessment, and certification support.",
      },
      {
  ...
  },
  {
    ...
    process: [
      ...
      },
      {
        ...
        description:
          "Map the attack surface using OSINT and active discovery.",
      },
      {
  ...
  },
  {
    ...
    shortDescription:
      "Breach preparedness, playbooks, and tabletop exercises.",
    category: "security",
    icon: AlertTriangle,
  ...
  },
  {
    ...
    icon: GraduationCap,
    question:
      "Expecting your team to secure what they don't understand?",
    description:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Automated budgets, forecasting, and approval workflows.",
      },
      {
    ...
    process: [
      ...
      },
      {
        ...
        description:
          "Design tagging taxonomy and cost allocation methodology.",
      },
      {
...
export const finopsServices = services.filter(
  (s) => s.category === "finops",
);
